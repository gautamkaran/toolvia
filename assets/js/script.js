...
const courseData = {
  ...
  SY: {
    ...
    "Sem 4": [
      {
        name: "Core Java",
        show: "./assets/QB/sem-4/core java/core java.html",
        download: "#",
      },
      {
        name: "Software Engineering ",
        show: "./assets/QB/sem-4/Software Engineer/Software Engineer.html",
        download: "#",
      },
      {
        name: "Introduction to Embedded Systems",
        show: "./assets/QB/sem-4/Embedded System/Introduction to Embedded Systems.html",
        download: "#",
      },
      {
        name: "Computer graphics and animation",
        show: "./assets/QB/sem-4/computer animation/Computer Animation.html",
        download: "#",
      },
      {
        name: "Computer Oriented Statistical Techniques",
        show: "./assets/QB/sem-4/Computer Oriented Statistical Techniques/index.html",
        download: "#",
      },
    ],
  },
...
Object.keys(courseData).forEach((year, index) => {
  ...
  Object.keys(courseData[year]).forEach((sem) => {
    ...
    let subjectContent = subjects.length
      ? subjects
          .map(
            (subject) => `
      <div class="subject">
...
function toggleAccordion(header) {
  ...
  if (content.classList.contains("open")) {
    ...
    header
      ...
      .forEach((arr) => (arr.style.transform = "rotate(0deg)"));
